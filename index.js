...
let allowedOrigins = [
    ...
    'http://localhost:1234',
    'http://localhost:4200',
    'https://my-flix-client-two.vercel.app',
    'https://my-flix-client-3sc4skagx-itzel-elizabeth-flores-projects.vercel.app'
];
...
/**
 * Middleware: Logs the requested URL to the console.
...
/**
 * Middleware: Adds a timestamp to the request object.
 * @param {Object} req - Express request object.
 * @param {Object} res - Express response object.
 * @param {Function} next - The next middleware function.
 */
 ...
 * @returns {Object} - An object containing the genre's description.
 */
 ...
 * @returns {Object} - An object containing the director's details.
 */
 ...
 * @name RegisterUser
 * @kind function
 * @param {string} Username - Required, min 5 characters, alphanumeric.
...
/**
 * PUT: Allows users to update their user info.
 * @name UpdateUser
 * @kind function
 * @requires passport - Requires JWT authentication.
 ...
 * @returns {string} - A message confirming deletion.
 */
